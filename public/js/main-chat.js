...
// Same as previously delivered all_fixed_final (autoStart + forced-offer)
...
// Auto prompt camera/mic on page load
...
socket.on('banned',({untilISO})=>{ alert(`You are temporarily banned until ${untilISO}.`); location.href='/'; });
